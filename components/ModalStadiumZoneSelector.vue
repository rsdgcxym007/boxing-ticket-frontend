<template>
  <div>
    ...
    <div
      ...
      class="fixed inset-0 bg-black/50 z-[999999] overflow-auto"
      @click.self="onClose"
    >
      <!-- Center Wrapper -->
      <div
      ...
      >
        <!-- Modal Container -->
        <div
          class="w-full max-w-[95%] sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto my-10 bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden"
        >
          <!-- Sticky Header -->
            ...
            >
              ...
              >
                ...
                <span class="text-cyan-500 font-bold">
                  {{ pageData.selectedSeats.length * 1500 }}
                </span>
                <span class="ml-1 text-sm text-gray-500">{{ t("baht") }}</span>
              </div>
              ...
              <div class="flex justify-center gap-3 flex-wrap pt-3">
                ...
                <button
                  @click="pageData.showPaymentModal = true"
    ...
    <!-- Payment Modal -->
    <PaymentModal
      v-if="pageData.showPaymentModal"
      :visible="pageData.showPaymentModal"
      :selectedSeats="pageData.selectedSeats"
      :zone="pageData.zoneKey"
      :total="pageData.selectedSeats.length * 1500"
      @close="pageData.showPaymentModal = false"
